...
if __name__=='__main__':
    ...
    print('\n현재 보고있는 history : ', History.show_history())

    print('\n* 이전 history로 이동 *')
    print('현재 보고있는 history : ', History.move_prev_history())
    print('현재 보고있는 history : ', History.move_prev_history())
    print('현재 보고있는 history : ', History.move_prev_history())

    print('\n* 이후 history로 이동 *')
    print('현재 보고있는 history : ', History.move_next_history())
    print('현재 보고있는 history : ', History.move_next_history())
    print('현재 보고있는 history : ', History.move_next_history())
    ...
    print('\n* 현재 보고있는 history 삭제 *')
    print('현재 보고있는 history : ', History.del_history())
    print_Current_History_Status(History)
